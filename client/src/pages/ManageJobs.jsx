  ...
  return (
    <div className='container p-4 max-w-5xl'>
      <div className='overflow-x-auto'>
        <table className='min-w-full bg-white border border-gray-200 max-sm:text-sm shadow'>
          <thead>
            <tr>
              <th className='px-4 py-2 border-b border-gray-200 text-left max-sm:hidden'>#</th>
              <th className='px-4 py-2 border-b border-gray-200 text-left'>Job Title</th>
              <th className='px-4 py-2 border-b border-gray-200 text-left max-sm:hidden'>Date</th>
              <th className='px-4 py-2 border-b border-gray-200 text-left max-sm:hidden'>Location</th>
              <th className='px-4 py-2 border-b border-gray-200 text-center'>Applicants</th>
              <th className='px-4 py-2 border-b border-gray-200 text-left'>Visible</th>
            </tr>
          </thead>
          <tbody>
