          ...
          <tbody>
            {viewApplicationsPageData.map((applicant,index)=>(
              <tr key={index} className='text-gray-700'>
                ...
                <td className='py-2 px-4 border-b border-gray-400 text-center flex'>
                  <img className='w-10 h-10 rounded-full mr-3 max-sm:hidden' src={applicant.imgSrc} alt="" />
                  <span>{applicant.name}</span>
                </td>
                <td className='py-2 px-4 border-b border-gray-400 max-sm:hidden'>{applicant.jobTitle}</td>
                <td className='py-2 px-4 border-b border-gray-400 max-sm:hidden'>{applicant.location}</td>
