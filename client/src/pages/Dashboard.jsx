  ...
  return (
    <div className='min-h-screen'>
            ...
            <div className='px-5 flex justify-between items-center'>
                ...
                {companyData && (
                    ...
                    <div className='relative group'>
                        <img className='w-8 border border-gray-200 rounded-full' src={companyData.img} alt="" />
                        <div className='absolute hidden group-hover:block top-0 right-0 z-10 text-black rounded pt-12'>
                            <ul className='list-none m-0 p-2 bg-white rounded-md border border-gray-50 text-sm'>
        ...
        <div className='flex items-start'>
            {/* Left side bar */}
            <div className='min-h-screen border-r-2 border-gray-100 flex-shrink-0'>
